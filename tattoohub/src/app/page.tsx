  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <div className="text-center">
            <div className="mb-6 inline-block">
              <Badge className="bg-teal-500/10 text-teal-300 border-teal-500/20 hover:bg-teal-500/20 text-sm px-4 py-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button size="lg" variant="outline" asChild className="border-2 border-slate-400 text-white hover:bg-white bg-slate-700 hover:text-slate-900 transition-all duration-300 text-lg px-8 py-6 hover:scale-105">
                <Link href="/auth/signup?role=artist">Join as Artist</Link>
              </Button>
            </div>
            
            {/* Stats */}
            <div className="grid grid-cols-3 gap-8 max-w-3xl mx-auto mt-20 pt-12 border-t border-slate-700/50">
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-teal-400 mb-2">{mockArtists.length}+</div>
                <div className="text-slate-400 text-sm md:text-base">Verified Artists</div>
              </div>
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-cyan-400 mb-2">500+</div>
                <div className="text-slate-400 text-sm md:text-base">Happy Customers</div>
              </div>
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-teal-400 mb-2">1000+</div>
                <div className="text-slate-400 text-sm md:text-base">Bookings Made</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-28 bg-gradient-to-b from-slate-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center p-12 hover:shadow-2xl transition-all duration-500 border-slate-200 bg-white group hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold mb-4 text-slate-900">Vetted Artists</h3>
            ...
            <Card className="text-center p-12 hover:shadow-2xl transition-all duration-500 border-slate-200 bg-white group hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold mb-4 text-slate-900">Easy Booking</h3>
              <p className="text-slate-600 leading-relaxed text-lg">
            ...
            <Card className="text-center p-12 hover:shadow-2xl transition-all duration-500 border-slate-200 bg-white group hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold mb-4 text-slate-900">Safe & Secure</h3>
              <p className="text-slate-600 leading-relaxed text-lg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {featuredArtists.map((artist) => {
              ...
              return (
              <Card key={artist.id} className="overflow-hidden hover:shadow-2xl transition-all duration-500 border-slate-200 group hover:-translate-y-2">
                <div className="relative h-56 overflow-hidden bg-gradient-to-br from-slate-100 to-slate-200">
                  ...
                  <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-full px-3 py-1 flex items-center space-x-1 shadow-lg">
                    ...
                    <span className="text-sm font-bold text-slate-900">{artist.rating}</span>
                  </div>
                </div>
                <CardContent className="p-6">
                  <h3 className="text-xl font-bold text-slate-900 mb-3">{artist.name}</h3>
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {artist.specialties.slice(0, 3).map((specialty, index) => (
                      <Badge key={index} variant="secondary" className="bg-teal-50 text-teal-700 hover:bg-teal-100 border border-teal-200">
                        {specialty}
                      </Badge>
                    ))}
                  </div>
                  <Button className="w-full bg-gradient-to-r from-slate-900 to-slate-700 hover:from-slate-800 hover:to-slate-600 group-hover:shadow-lg transition-all duration-300" asChild>
                    <Link href="/customer/browse">
                      View Profile
      ...
      <section className="py-28 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-teal-900/30 via-transparent to-transparent"></div>
        ...
        <div className="relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <Badge className="bg-teal-500/10 text-teal-300 border-teal-500/20 hover:bg-teal-500/20 mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button size="lg" variant="outline" asChild className="border-2 border-slate-400 text-white hover:bg-white hover:text-slate-900 transition-all duration-300 text-lg px-8 py-6 hover:scale-105 bg-slate-700">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-3 mb-8 group cursor-pointer">
              ...
              <span className="font-bold text-2xl bg-gradient-to-r from-white to-slate-300 bg-clip-text text-transparent">TattooHub</span>
            </div>
            ...
            <div className="flex justify-center space-x-8 mb-10">
              <Link href="#" className="text-slate-400 hover:text-teal-400 transition-colors text-base font-medium">
                Privacy Policy
              </Link>
              <Link href="#" className="text-slate-400 hover:text-teal-400 transition-colors text-base font-medium">
                Terms of Service
